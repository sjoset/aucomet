...
def main():
    ...
    for apsize in np.geomspace(1.e5, 5.e8, num=50, endpoint=True):
        add_aperture_calc_column(test_table, sba.CircularAperture(apsize * u.km), f"{apsize:5.4e}_km_aperture_count")
