...
def show_fragment_agreement(coma):
    print("\nFragment agreement check:")
    print(f"Theoretical total number of fragments in coma:\t\t\t {coma.vmodel['num_fragments_theory']:.7e}")
    print(f"Total number of fragments from density grid integration:\t {coma.vmodel['num_fragments_grid']:.7e}")
